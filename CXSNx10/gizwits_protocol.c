...
static int8_t ICACHE_FLASH_ATTR gizDataPoint2Event(gizwitsIssued_t *issuedData, eventInfo_t *info, dataPoint_t *dataPoints)
{
    ...
    if(0x01 == issuedData->attrFlags.flagLED_ONOFF1)
    {
        info->event[info->num] = EVENT_LED_ONOFF1;
        info->num++;
        dataPoints->valueLED_ONOFF1 = gizStandardDecompressionValue(LED_ONOFF1_BYTEOFFSET,LED_ONOFF1_BITOFFSET,LED_ONOFF1_LEN,(uint8_t *)&issuedData->attrVals.wBitBuf,sizeof(issuedData->attrVals.wBitBuf));
    }
        
    if(0x01 == issuedData->attrFlags.flagLED_ONOFF2)
    {
        info->event[info->num] = EVENT_LED_ONOFF2;
        info->num++;
        dataPoints->valueLED_ONOFF2 = gizStandardDecompressionValue(LED_ONOFF2_BYTEOFFSET,LED_ONOFF2_BITOFFSET,LED_ONOFF2_LEN,(uint8_t *)&issuedData->attrVals.wBitBuf,sizeof(issuedData->attrVals.wBitBuf));
    }
        
    if(0x01 == issuedData->attrFlags.flagPMOS1)
    {
        info->event[info->num] = EVENT_PMOS1;
        info->num++;
        dataPoints->valuePMOS1 = gizStandardDecompressionValue(PMOS1_BYTEOFFSET,PMOS1_BITOFFSET,PMOS1_LEN,(uint8_t *)&issuedData->attrVals.wBitBuf,sizeof(issuedData->attrVals.wBitBuf));
    }
        
    if(0x01 == issuedData->attrFlags.flagPMOS2)
    {
        info->event[info->num] = EVENT_PMOS2;
        info->num++;
        dataPoints->valuePMOS2 = gizStandardDecompressionValue(PMOS2_BYTEOFFSET,PMOS2_BITOFFSET,PMOS2_LEN,(uint8_t *)&issuedData->attrVals.wBitBuf,sizeof(issuedData->attrVals.wBitBuf));
    }
        
        
    if(0x01 == issuedData->attrFlags.flagxRGB1)
    {
        info->event[info->num] = EVENT_xRGB1;
        info->num++;
        dataPoints->valuexRGB1 = gizX2Y(xRGB1_RATIO,  xRGB1_ADDITION, issuedData->attrVals.valuexRGB1); 
    }
        
    if(0x01 == issuedData->attrFlags.flagxRGB_rad1)
    {
        info->event[info->num] = EVENT_xRGB_rad1;
        info->num++;
        dataPoints->valuexRGB_rad1 = gizX2Y(xRGB_rad1_RATIO,  xRGB_rad1_ADDITION, issuedData->attrVals.valuexRGB_rad1); 
    }
        
    if(0x01 == issuedData->attrFlags.flagxRGB_green1)
    {
        info->event[info->num] = EVENT_xRGB_green1;
        info->num++;
        dataPoints->valuexRGB_green1 = gizX2Y(xRGB_green1_RATIO,  xRGB_green1_ADDITION, issuedData->attrVals.valuexRGB_green1); 
    }
        
    if(0x01 == issuedData->attrFlags.flagxRGB_blue1)
    {
        info->event[info->num] = EVENT_xRGB_blue1;
        info->num++;
        dataPoints->valuexRGB_blue1 = gizX2Y(xRGB_blue1_RATIO,  xRGB_blue1_ADDITION, issuedData->attrVals.valuexRGB_blue1); 
    }
        
    if(0x01 == issuedData->attrFlags.flagyRGB2)
    {
        info->event[info->num] = EVENT_yRGB2;
        info->num++;
        dataPoints->valueyRGB2 = gizX2Y(yRGB2_RATIO,  yRGB2_ADDITION, issuedData->attrVals.valueyRGB2); 
    }
        
    if(0x01 == issuedData->attrFlags.flagyRGB_rad2)
    {
        info->event[info->num] = EVENT_yRGB_rad2;
        info->num++;
        dataPoints->valueyRGB_rad2 = gizX2Y(yRGB_rad2_RATIO,  yRGB_rad2_ADDITION, issuedData->attrVals.valueyRGB_rad2); 
    }
        
    if(0x01 == issuedData->attrFlags.flagyRGB_green2)
    {
        info->event[info->num] = EVENT_yRGB_green2;
        info->num++;
        dataPoints->valueyRGB_green2 = gizX2Y(yRGB_green2_RATIO,  yRGB_green2_ADDITION, issuedData->attrVals.valueyRGB_green2); 
    }
        
    if(0x01 == issuedData->attrFlags.flagyRGB_blue2)
    {
        info->event[info->num] = EVENT_yRGB_blue2;
        info->num++;
        dataPoints->valueyRGB_blue2 = gizX2Y(yRGB_blue2_RATIO,  yRGB_blue2_ADDITION, issuedData->attrVals.valueyRGB_blue2); 
    }
...
static int8_t ICACHE_FLASH_ATTR gizCheckReport(dataPoint_t *cur, dataPoint_t *last)
{
    ...
    if(last->valueLED_ONOFF1 != cur->valueLED_ONOFF1)
    {
        GIZWITS_LOG("valueLED_ONOFF1 Changed\n");
        ret = 1;
    }
    if(last->valueLED_ONOFF2 != cur->valueLED_ONOFF2)
    {
        GIZWITS_LOG("valueLED_ONOFF2 Changed\n");
        ret = 1;
    }
    if(last->valuePMOS1 != cur->valuePMOS1)
    {
        GIZWITS_LOG("valuePMOS1 Changed\n");
        ret = 1;
    }
    if(last->valuePMOS2 != cur->valuePMOS2)
    {
        GIZWITS_LOG("valuePMOS2 Changed\n");
        ret = 1;
    }
    if(last->valuexRGB1 != cur->valuexRGB1)
    {
        GIZWITS_LOG("valuexRGB1 Changed\n");
        ret = 1;
    }
    if(last->valuexRGB_rad1 != cur->valuexRGB_rad1)
    {
        GIZWITS_LOG("valuexRGB_rad1 Changed\n");
        ret = 1;
    }
    if(last->valuexRGB_green1 != cur->valuexRGB_green1)
    {
        GIZWITS_LOG("valuexRGB_green1 Changed\n");
        ret = 1;
    }
    if(last->valuexRGB_blue1 != cur->valuexRGB_blue1)
    {
        GIZWITS_LOG("valuexRGB_blue1 Changed\n");
        ret = 1;
    }
    if(last->valueyRGB2 != cur->valueyRGB2)
    {
        GIZWITS_LOG("valueyRGB2 Changed\n");
        ret = 1;
    }
    if(last->valueyRGB_rad2 != cur->valueyRGB_rad2)
    {
        GIZWITS_LOG("valueyRGB_rad2 Changed\n");
        ret = 1;
    }
    if(last->valueyRGB_green2 != cur->valueyRGB_green2)
    {
        GIZWITS_LOG("valueyRGB_green2 Changed\n");
        ret = 1;
    }
    if(last->valueyRGB_blue2 != cur->valueyRGB_blue2)
    {
        GIZWITS_LOG("valueyRGB_blue2 Changed\n");
        ret = 1;
    }
    if(last->valueremind1 != cur->valueremind1)
    {
        GIZWITS_LOG("valueremind1 Changed\n");
        ret = 1;
    }
    if(last->valueremind2 != cur->valueremind2)
    {
        GIZWITS_LOG("valueremind2 Changed\n");
        ret = 1;
    }
    if(last->valueremind3 != cur->valueremind3)
    {
        GIZWITS_LOG("valueremind3 Changed\n");
        ret = 1;
    }
    if(last->valueremind4 != cur->valueremind4)
    {
        GIZWITS_LOG("valueremind4 Changed\n");
        ret = 1;
    }

    if(last->valueADC_1 != cur->valueADC_1)
    {
        if(currentTime - lastReportTime >= REPORT_TIME_MAX)
        {
            GIZWITS_LOG("valueADC_1 Changed\n");
            ret = 1;
        }
    }
    if(last->valueHumiture1 != cur->valueHumiture1)
    {
        if(currentTime - lastReportTime >= REPORT_TIME_MAX)
        {
            GIZWITS_LOG("valueHumiture1 Changed\n");
            ret = 1;
        }
    }
    if(last->valueHumiture2 != cur->valueHumiture2)
    {
        if(currentTime - lastReportTime >= REPORT_TIME_MAX)
        {
            GIZWITS_LOG("valueHumiture2 Changed\n");
            ret = 1;
        }
    }
...
static int8_t ICACHE_FLASH_ATTR gizDataPoints2ReportData(dataPoint_t *dataPoints , devStatus_t *devStatusPtr)
{
    ...
    gizStandardCompressValue(LED_ONOFF1_BYTEOFFSET,LED_ONOFF1_BITOFFSET,LED_ONOFF1_LEN,(uint8_t *)devStatusPtr,dataPoints->valueLED_ONOFF1);
    gizStandardCompressValue(LED_ONOFF2_BYTEOFFSET,LED_ONOFF2_BITOFFSET,LED_ONOFF2_LEN,(uint8_t *)devStatusPtr,dataPoints->valueLED_ONOFF2);
    gizStandardCompressValue(PMOS1_BYTEOFFSET,PMOS1_BITOFFSET,PMOS1_LEN,(uint8_t *)devStatusPtr,dataPoints->valuePMOS1);
    gizStandardCompressValue(PMOS2_BYTEOFFSET,PMOS2_BITOFFSET,PMOS2_LEN,(uint8_t *)devStatusPtr,dataPoints->valuePMOS2);
    if(dataPoints->valueremind1 >= remind1_VALUE_MAX)
    {
        GIZWITS_LOG("[ERROR] valueremind1 Error , Illegal Overstep\n");
        return -1;
    }
    else
    {
        gizStandardCompressValue(remind1_BYTEOFFSET,remind1_BITOFFSET,remind1_LEN,(uint8_t *)devStatusPtr,dataPoints->valueremind1);  
    }
    if(dataPoints->valueremind2 >= remind2_VALUE_MAX)
    {
        GIZWITS_LOG("[ERROR] valueremind2 Error , Illegal Overstep\n");
        return -1;
    }
    else
    {
        gizStandardCompressValue(remind2_BYTEOFFSET,remind2_BITOFFSET,remind2_LEN,(uint8_t *)devStatusPtr,dataPoints->valueremind2);  
    }
    if(dataPoints->valueremind3 >= remind3_VALUE_MAX)
    {
        GIZWITS_LOG("[ERROR] valueremind3 Error , Illegal Overstep\n");
        return -1;
    }
    else
    {
        gizStandardCompressValue(remind3_BYTEOFFSET,remind3_BITOFFSET,remind3_LEN,(uint8_t *)devStatusPtr,dataPoints->valueremind3);  
    }
    if(dataPoints->valueremind4 >= remind4_VALUE_MAX)
    {
        GIZWITS_LOG("[ERROR] valueremind4 Error , Illegal Overstep\n");
        return -1;
    }
    else
    {
        gizStandardCompressValue(remind4_BYTEOFFSET,remind4_BITOFFSET,remind4_LEN,(uint8_t *)devStatusPtr,dataPoints->valueremind4);  
    }
    ...
    devStatusPtr->valuexRGB1 = gizY2X(xRGB1_RATIO,  xRGB1_ADDITION, dataPoints->valuexRGB1); 
    devStatusPtr->valuexRGB_rad1 = gizY2X(xRGB_rad1_RATIO,  xRGB_rad1_ADDITION, dataPoints->valuexRGB_rad1); 
    devStatusPtr->valuexRGB_green1 = gizY2X(xRGB_green1_RATIO,  xRGB_green1_ADDITION, dataPoints->valuexRGB_green1); 
    devStatusPtr->valuexRGB_blue1 = gizY2X(xRGB_blue1_RATIO,  xRGB_blue1_ADDITION, dataPoints->valuexRGB_blue1); 
    devStatusPtr->valueyRGB2 = gizY2X(yRGB2_RATIO,  yRGB2_ADDITION, dataPoints->valueyRGB2); 
    devStatusPtr->valueyRGB_rad2 = gizY2X(yRGB_rad2_RATIO,  yRGB_rad2_ADDITION, dataPoints->valueyRGB_rad2); 
    devStatusPtr->valueyRGB_green2 = gizY2X(yRGB_green2_RATIO,  yRGB_green2_ADDITION, dataPoints->valueyRGB_green2); 
    devStatusPtr->valueyRGB_blue2 = gizY2X(yRGB_blue2_RATIO,  yRGB_blue2_ADDITION, dataPoints->valueyRGB_blue2); 

    devStatusPtr->valueADC_1 = exchangeBytes(gizY2X(ADC_1_RATIO,  ADC_1_ADDITION, dataPoints->valueADC_1)); 
    devStatusPtr->valueHumiture1 = exchangeBytes(gizY2XFloat(Humiture1_RATIO,  Humiture1_ADDITION, dataPoints->valueHumiture1));     
    devStatusPtr->valueHumiture2 = exchangeBytes(gizY2XFloat(Humiture2_RATIO,  Humiture2_ADDITION, dataPoints->valueHumiture2));     
