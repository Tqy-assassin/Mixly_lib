...
* @{
*/
#define PRODUCT_KEY "f1a34c6ecbd540e8b70072d1c39a16c7"
/**@} */
/**@name Product Secret  
* @{
*/
#define PRODUCT_SECRET "db40d3b17657437b8da37acd5627d7ac"
...
#define LED_ONOFF1_BYTEOFFSET                    0
#define LED_ONOFF1_BITOFFSET                     1
#define LED_ONOFF1_LEN                           1
#define LED_ONOFF2_BYTEOFFSET                    0
#define LED_ONOFF2_BITOFFSET                     2
#define LED_ONOFF2_LEN                           1
#define PMOS1_BYTEOFFSET                    0
#define PMOS1_BITOFFSET                     3
#define PMOS1_LEN                           1
#define PMOS2_BYTEOFFSET                    0
#define PMOS2_BITOFFSET                     4
#define PMOS2_LEN                           1
#define remind1_BYTEOFFSET                    9
#define remind1_BITOFFSET                     0
#define remind1_LEN                           3
#define remind2_BYTEOFFSET                    9
#define remind2_BITOFFSET                     3
#define remind2_LEN                           3
#define remind3_BYTEOFFSET                    9
#define remind3_BITOFFSET                     6
#define remind3_LEN                           3
#define remind4_BYTEOFFSET                    10
#define remind4_BITOFFSET                     9
#define remind4_LEN                           3

#define xRGB1_RATIO                         10
#define xRGB1_ADDITION                      0
#define xRGB1_MIN                           0
#define xRGB1_MAX                           10
#define xRGB_rad1_RATIO                         1
#define xRGB_rad1_ADDITION                      0
#define xRGB_rad1_MIN                           0
#define xRGB_rad1_MAX                           254
#define xRGB_green1_RATIO                         1
#define xRGB_green1_ADDITION                      0
#define xRGB_green1_MIN                           0
#define xRGB_green1_MAX                           254
#define xRGB_blue1_RATIO                         1
#define xRGB_blue1_ADDITION                      0
#define xRGB_blue1_MIN                           0
#define xRGB_blue1_MAX                           254
#define yRGB2_RATIO                         10
#define yRGB2_ADDITION                      0
#define yRGB2_MIN                           0
#define yRGB2_MAX                           10
#define yRGB_rad2_RATIO                         1
#define yRGB_rad2_ADDITION                      0
#define yRGB_rad2_MIN                           0
#define yRGB_rad2_MAX                           254
#define yRGB_green2_RATIO                         1
#define yRGB_green2_ADDITION                      0
#define yRGB_green2_MIN                           0
#define yRGB_green2_MAX                           254
#define yRGB_blue2_RATIO                         1
#define yRGB_blue2_ADDITION                      0
#define yRGB_blue2_MIN                           0
#define yRGB_blue2_MAX                           254
#define ADC_1_RATIO                         1
#define ADC_1_ADDITION                      0
#define ADC_1_MIN                           0
#define ADC_1_MAX                           1023
#define Humiture1_RATIO                         0.1
#define Humiture1_ADDITION                      0
#define Humiture1_MIN                           0
#define Humiture1_MAX                           1000
#define Humiture2_RATIO                         0.1
#define Humiture2_ADDITION                      0
#define Humiture2_MIN                           0
#define Humiture2_MAX                           1000
#define PM25_RATIO                         1
#define PM25_ADDITION                      0
#define PM25_MIN                           0
#define PM25_MAX                           1023
/**@} */
...
typedef enum
{
    remind1_VALUE0 = 0,//正常
    remind1_VALUE1 = 1,//警报
    remind1_VALUE2 = 2,//烟雾浓度超标
    remind1_VALUE3 = 3,//酒精浓度超标
    remind1_VALUE4 = 4,//检测到火焰
    remind1_VALUE5 = 5,//检测到酒精
    remind1_VALUE6 = 6,//检测到烟雾
    remind1_VALUE_MAX,
} remind1_ENUM_T;
typedef enum
{
    remind2_VALUE0 = 0,//正常
    remind2_VALUE1 = 1,//警报
    remind2_VALUE2 = 2,//烟雾浓度超标
    remind2_VALUE3 = 3,//酒精浓度超标
    remind2_VALUE4 = 4,//检测到火焰
    remind2_VALUE5 = 5,//检测到酒精
    remind2_VALUE6 = 6,//检测到烟雾
    remind2_VALUE_MAX,
} remind2_ENUM_T;
typedef enum
{
    remind3_VALUE0 = 0,//满
    remind3_VALUE1 = 1,//空
    remind3_VALUE2 = 2,//烟雾浓度超标
    remind3_VALUE3 = 3,//酒精浓度超标
    remind3_VALUE4 = 4,//检测到火焰
    remind3_VALUE5 = 5,//检测到酒精
    remind3_VALUE6 = 6,//检测到烟雾
    remind3_VALUE_MAX,
} remind3_ENUM_T;
typedef enum
{
    remind4_VALUE0 = 0,//满
    remind4_VALUE1 = 1,//空
    remind4_VALUE2 = 2,//烟雾浓度超标
    remind4_VALUE3 = 3,//酒精浓度超标
    remind4_VALUE4 = 4,//检测到火焰
    remind4_VALUE5 = 5,//检测到酒精
    remind4_VALUE6 = 6,//检测到烟雾
    remind4_VALUE_MAX,
} remind4_ENUM_T;
...
typedef struct {
  bool valueLED_ONOFF;
  bool valueLED_ONOFF1;
  bool valueLED_ONOFF2;
  bool valuePMOS1;
  bool valuePMOS2;
  uint32_t valuexRGB1;
  uint32_t valuexRGB_rad1;
  uint32_t valuexRGB_green1;
  uint32_t valuexRGB_blue1;
  uint32_t valueyRGB2;
  uint32_t valueyRGB_rad2;
  uint32_t valueyRGB_green2;
  uint32_t valueyRGB_blue2;
  uint32_t valueremind1;
  uint32_t valueremind2;
  uint32_t valueremind3;
  uint32_t valueremind4;
  uint32_t valueADC_1;
  float valueHumiture1;
  float valueHumiture2;
  uint32_t valuePM25;
} dataPoint_t;
...
typedef struct {
  ...
  uint8_t flagLED_ONOFF1:1;
  uint8_t flagLED_ONOFF2:1;
  uint8_t flagPMOS1:1;
  uint8_t flagPMOS2:1;
  uint8_t flagxRGB1:1;
  uint8_t flagxRGB_rad1:1;
  uint8_t flagxRGB_green1:1;
  uint8_t flagxRGB_blue1:1;
  uint8_t flagyRGB2:1;
  uint8_t flagyRGB_rad2:1;
  uint8_t flagyRGB_green2:1;
  uint8_t flagyRGB_blue2:1;
} attrFlags_t;
...
typedef struct {
  ...
  uint8_t valuexRGB1;
  uint8_t valuexRGB_rad1;
  uint8_t valuexRGB_green1;
  uint8_t valuexRGB_blue1;
  uint8_t valueyRGB2;
  uint8_t valueyRGB_rad2;
  uint8_t valueyRGB_green2;
  uint8_t valueyRGB_blue2;
} attrVals_t;
...
typedef struct {
  ...
  uint16_t valueADC_1;
  uint16_t valueHumiture1;
  uint16_t valueHumiture2;
  uint16_t valuePM25;
} devStatus_t; 
